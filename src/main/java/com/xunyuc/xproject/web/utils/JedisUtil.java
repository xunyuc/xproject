...
/**
 * Created by Xunyuc on 2017/7/30.
 */
public class JedisUtil {
    private static Logger logger = LoggerFactory.getLogger(JedisUtil.class);
    private static JedisSentinelPool jedisPool = SpringContextUtil.getBean(JedisSentinelPool.class);
    ...
    public static byte[] getBytesKey(Object object){
        if(object instanceof String){
            return ((String)object).getBytes(); //TODO charset
        }else{
    ...
    public static Object getObjectKey(byte[] key){
        try{
            return new String(key); //TODO charset
